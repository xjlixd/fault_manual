create or replace view v_index_bloat
as 
WITH btree_index_atts AS (
 ...
 SELECT format_bloat.database_name AS datname,
    ...
    format_bloat.table_mb AS heap_table_mb,
    (format_bloat.index_mb - format_bloat.bloat_mb) AS index_actual_mb,
    format_bloat.bloat_mb as index_bloat_mb,
